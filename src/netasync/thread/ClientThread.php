...
class ClientThread extends Thread {
    ...
    /** @var int */
    private $status = self::STATUS_CONNECTING;
    ...
    public function connect(): void {
        ...
        if ($newSocket !== null) {
            ...
            $this->writePacket((AuthenticateClientPacket::init($data['description'], $data['group'], $data['password'], $data['isLobbyServer']))->encode());
        } else {
            $this->status = self::STATUS_RECONNECTING;
        }
    }
